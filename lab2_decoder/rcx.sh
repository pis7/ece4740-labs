#!/bin/ksh
# This script was generated Tue Mar 26 20:59:57 2024 by:
#
...
#	/home/pis7/Cadence/lab2_decoder.xcn -assura_run_dir \
#	/home/pis7/Cadence -assura_run_name lab2_decoder -rcxdir \
#	/home/pis7/Cadence/lab2_decoder -xy_coordinates c,r -type full \
#	-temperature 25.0 -tempdir /home/pis7/Cadence/lab2_decoder/rcx_temp \
...
#	/home/pis7/Cadence/lab2_decoder/extview.tmp -net_name_space layout \
#	-minR 0.001 -minC_by_percentage 0.1 -minC 1e-17 -max_merged_via_size \
#	auto -max_fracture_length infinite -macro_cell -m_factorR infinite \
...
##NETS_FILE=/dev/null
##OUTPUT=/home/pis7/Cadence/lab2_decoder/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/pis7/Cadence/lab2_decoder
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/pis7/Cadence/lab2_decoder/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
TEMPDIR=`setTempDir /home/pis7/Cadence/lab2_decoder/rcx_temp`
export TEMPDIR
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/pis7/Cadence/lab2_decoder
...
/home/pis7/Cadence/lab2_decoder.xcn
ENDCAT
...
export GOALIE2DIR
vdbToRcx /home/pis7/Cadence lab2_decoder -unit meters -mFactorR -- -V1 -H \
	satfile -r /home/pis7/Cadence/lab2_decoder.xcn -df2 -xgl
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -sc caps2dversion -mx capfile \
	...
	/home/pis7/Cadence/lab2_decoder/extview.tmp
