...
sip -V -s -cgnd 2 -sub 2 -L3A -h -R mt8 -b 	mt5,mt4,mt3,mt2,mt1,poly,diff,sti -t mt9 -Maxw 6.6 -p 	mt6:mt6_cut,key,mt8,key 0,6.6,0 - mt6_mt8.sip
sip -V -s -cgnd 2 -sub 2 -h -b mt5,mt4,mt3,mt2,mt1,poly,diff,sti 	-t mt8,mt9 -Maxw 2.1 -p mt6:mt6_cut,key,mt7,key 0,2.1,0 - mt6_mt7.sip
sip -V -s -cgnd 2 -sub 2 -L3A -h -R mt7 -b 	mt4,mt3,mt2,mt1,poly,diff,sti -t mt8,mt9 -k mt6:0.36 -Maxw 2.1 -p 	mt5:mt5_cut,key,mt7,key 0,2.1,0 - mt5_mt7.sip
sip -V -s -cgnd 2 -sub 2 -h -b mt4,mt3,mt2,mt1,poly,diff,sti -t 	mt7,mt8,mt9 -Maxw 2.1 -p mt5:mt5_cut,key,mt6:mt6_cut,key 0,2.1,0 - 	mt5_mt6.sip
sip -V -s -cgnd 2 -sub 2 -L3A -h -R mt6 -b 	mt3,mt2,mt1,poly,diff,sti -t mt7,mt8,mt9 -k mt5:0.36 -Maxw 2.1 -p 	mt4:mt4_cut,key,mt6:mt6_cut,key 0,2.1,0 - mt4_mt6.sip
sip -V -s -cgnd 2 -sub 2 -h -b mt3,mt2,mt1,poly,diff,sti -t 	mt6,mt7,mt8,mt9 -Maxw 2.1 -p mt4:mt4_cut,key,mt5:mt5_cut,key 0,2.1,0 	- mt4_mt5.sip
sip -V -s -cgnd 2 -sub 2 -L3A -h -R mt5 -b mt2,mt1,poly,diff,sti 	-t mt6,mt7,mt8,mt9 -k mt4:0.36 -Maxw 2.1 -p 	mt3:mt3_cut,key,mt5:mt5_cut,key 0,2.1,0 - mt3_mt5.sip
sip -V -s -cgnd 2 -sub 2 -h -b mt2,mt1,poly,diff,sti -t 	mt5,mt6,mt7,mt8,mt9 -Maxw 2.1 -p mt3:mt3_cut,key,mt4:mt4_cut,key 	0,2.1,0 - mt3_mt4.sip
sip -V -s -cgnd 2 -sub 2 -L3A -h -R mt4 -b mt1,poly,diff,sti -t 	mt5,mt6,mt7,mt8,mt9 -k mt3:0.36 -Maxw 2.1 -p 	mt2:mt2_cut,key,mt4:mt4_cut,key 0,2.1,0 - mt2_mt4.sip
sip -V -s -cgnd 2 -sub 2 -h -b mt1,poly,diff,sti -t 	mt4,mt5,mt6,mt7,mt8,mt9 -Maxw 2.1 -p mt2:mt2_cut,key,mt3:mt3_cut,key 	0,2.1,0 - mt2_mt3.sip
sip -V -s -cgnd 2 -sub 2 -L3A -h -R mt3 -b poly,diff,sti -t 	mt4,mt5,mt6,mt7,mt8,mt9 -k mt2:0.36 -Maxw 2.1 -p 	mt1:mt1_cut,key,mt3:mt3_cut,key 0,2.1,0 - mt1_mt3.sip
sip -V -s -cgnd 2 -sub 2 -h -b poly,diff,sti -t 	mt3,mt4,mt5,mt6,mt7,mt8,mt9 -Maxw 2.1 -p 	mt1:mt1_cut,key,mt2:mt2_cut,key 0,1.4,0 - mt1_mt2.sip
sip -V -s -cgnd 2 -sub 2 -L3A -h -R mt2 -b diff,sti -t 	mt3,mt4,mt5,mt6,mt7,mt8,mt9 -k mt1:0.3 -Maxw 2.1 -p 	poly:poly_cut,key,mt2:mt2_cut,key 0,1.4,0 - poly_mt2.sip
