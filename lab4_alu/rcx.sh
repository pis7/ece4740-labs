#!/bin/ksh
# This script was generated Sat May 18 14:09:58 2024 by:
#
...
#	/home/pis7/Cadence/lab4_alu.xcn -assura_run_dir /home/pis7/Cadence \
#	-assura_run_name lab4_alu -rcxdir /home/pis7/Cadence/lab4_alu \
#	-xy_coordinates c,r -type full -temperature 25.0 -tempdir \
#	/home/pis7/Cadence/lab4_alu/rcx_temp -sub_node_char # -res_models no \
#	-parasitic_res_models comment -parasitic_cap_models no \
#	-output_net_name_space layout -output_hierarchy_delimiter / -output \
#	/home/pis7/Cadence/lab4_alu/extview.tmp -net_name_space layout -minR \
#	0.001 -minC_by_percentage 0.1 -minC 1e-17 -max_merged_via_size auto \
...
##NETS_FILE=/dev/null
##OUTPUT=/home/pis7/Cadence/lab4_alu/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/pis7/Cadence/lab4_alu
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/pis7/Cadence/lab4_alu/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
TEMPDIR=`setTempDir /home/pis7/Cadence/lab4_alu/rcx_temp`
export TEMPDIR
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/pis7/Cadence/lab4_alu
...
/home/pis7/Cadence/lab4_alu.xcn
ENDCAT
...
export GOALIE2DIR
vdbToRcx /home/pis7/Cadence lab4_alu -unit meters -mFactorR -- -V1 -H satfile \
	-r /home/pis7/Cadence/lab4_alu.xcn -df2 -xgl
...
geom -V Via5 metal6_conn metal5_conn - Via5,111,i,2
geom -V Via4 metal5_conn metal4_conn - Via4,111,i,2
geom -V Via3 metal4_conn metal3_conn - Via3,111,i,2
geom -V via2_out_capInd metal3_conn metal2_conn - via2_out_capInd,111,i,2
...
flattenLayers -m metal6_conn metal5_conn metal4_conn metal3_conn metal2_conn \
	metal1_conn poly_conn ndiff_conn pdiff_conn nwell_conn psubstrate \
	Via5 Via4 Via3 via2_out_capInd Via1 Metal1_v Metal1_p cont_poly \
	cont_pdiff cont_ndiff ptap_pdiff_conn_ovia ptap psubstrate_ptap_ovia \
...
selectNetsByNumber power_list_nums metal3_conn p_rmetal3_conn np_rmetal3_conn
selectNetsByNumber power_list_nums metal4_conn p_rmetal4_conn np_rmetal4_conn
selectNetsByNumber power_list_nums metal5_conn p_rmetal5_conn np_rmetal5_conn
selectNetsByNumber power_list_nums metal6_conn p_rmetal6_conn np_rmetal6_conn
...
selectNetsByNumber power_list_nums via2_out_capInd p_rvia2_out_capInd np_rvia2_out_capInd
...
mergevia -V -tech /opt/cadence-designkits/gpdk090_v4.6/assura/rcx -cnt \
	np_rVia3 rVia3 - np_rmetal4_conn np_rmetal3_conn
mergevia -V -tech /opt/cadence-designkits/gpdk090_v4.6/assura/rcx -cnt \
	np_rVia4 rVia4 - np_rmetal5_conn np_rmetal4_conn
mergevia -V -tech /opt/cadence-designkits/gpdk090_v4.6/assura/rcx -cnt \
	np_rVia5 rVia5 - np_rmetal6_conn np_rmetal5_conn
mergevia -V -tech /opt/cadence-designkits/gpdk090_v4.6/assura/rcx -cnt \
	np_rcont_poly rcont_poly - np_rmetal1_conn np_rpoly_conn
mergevia -V -tech /opt/cadence-designkits/gpdk090_v4.6/assura/rcx -cnt \
	np_rvia2_out_capInd rvia2_out_capInd - np_rmetal3_conn \
	np_rmetal2_conn
...
connect -V -relocate NET np_rMetal1_p:np_rMetal1_p.conn \
	...
	np_rntap:np_rntap.conn np_rptap:np_rptap.conn rVia1 rVia3 rVia4 rVia5 \
	rcont_poly rvia2_out_capInd _nmos_12_MOS_1_mgvia _pmos_12_MOS_7_mgvia \
	- ntap_ndiff_conn_ovia,6,4 nwell_conn_ntap_ovia,2,6 \
	psubstrate_ptap_ovia,3,7 ptap_pdiff_conn_ovia,7,5 - \
	Metal1_p_pintext_nr_labs,1
...
rex -V -m -pd -I'#' -tech /opt/cadence-designkits/gpdk090_v4.6/assura/rcx \
	...
	np_rmetal2_conn::mt2_cut np_rmetal3_conn::mt3_cut \
	np_rmetal4_conn::mt4_cut np_rmetal5_conn::mt5_cut \
	np_rmetal6_conn::mt6_cut - rMetal1_v,2 rVia1,2,3,t rVia3,4,5,t \
	rVia4,5,6,t rVia5,6,7,t rcont_ndiff,2,t rcont_pdiff,2,t \
	rcont_poly,1,2,t rvia2_out_capInd,3,4,t _nmos_12_MOS_1_mgvia,1,z \
...
stamp -V -i2 np_rmetal4_conn rVia3 np_rVia3
geom -V np_rVia3,p_rVia3 - rVia3,1,i,1
stamp -V -i2 np_rmetal5_conn rVia4 np_rVia4
geom -V np_rVia4,p_rVia4 - rVia4,1,i,1
stamp -V -i2 np_rmetal6_conn rVia5 np_rVia5
...
stamp -V -i2 np_rmetal3_conn rvia2_out_capInd np_rvia2_out_capInd
geom -V np_rvia2_out_capInd,p_rvia2_out_capInd - rvia2_out_capInd,1,i,1
...
geom -V -i p_rmetal3_conn,np_rmetal3_conn - so_mt3,1,n
geom -V p_rmetal3_conn,np_rmetal3_conn - mt3,1,i,1
geom -V -i p_rmetal4_conn,np_rmetal4_conn - so_mt4,1,n
geom -V p_rmetal4_conn,np_rmetal4_conn - mt4,1,i,1
geom -V -i p_rmetal5_conn,np_rmetal5_conn - so_mt5,1,n
geom -V p_rmetal5_conn,np_rmetal5_conn - mt5,1,i,1
geom -V -i p_rmetal6_conn,np_rmetal6_conn - so_mt6,1,n
geom -V p_rmetal6_conn,np_rmetal6_conn - mt6,1,i,1
...
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R mt8 -b \
	mt5,mt4,mt3,mt2,mt1,poly,diff,sti -t mt9 -Maxw 6.6 -p \
	mt6:mt6_cut,key,mt8,key 0,6.6,0 - mt6_mt8.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -h -b mt5,mt4,mt3,mt2,mt1,poly,diff,sti \
	-t mt8,mt9 -Maxw 2.1 -p mt6:mt6_cut,key,mt7,key 0,2.1,0 - mt6_mt7.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R mt7 -b \
	mt4,mt3,mt2,mt1,poly,diff,sti -t mt8,mt9 -k mt6:0.36 -Maxw 2.1 -p \
	mt5:mt5_cut,key,mt7,key 0,2.1,0 - mt5_mt7.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -h -b mt4,mt3,mt2,mt1,poly,diff,sti -t \
	mt7,mt8,mt9 -Maxw 2.1 -p mt5:mt5_cut,key,mt6:mt6_cut,key 0,2.1,0 - \
	mt5_mt6.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R mt6 -b \
	mt3,mt2,mt1,poly,diff,sti -t mt7,mt8,mt9 -k mt5:0.36 -Maxw 2.1 -p \
	mt4:mt4_cut,key,mt6:mt6_cut,key 0,2.1,0 - mt4_mt6.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -h -b mt3,mt2,mt1,poly,diff,sti -t \
	mt6,mt7,mt8,mt9 -Maxw 2.1 -p mt4:mt4_cut,key,mt5:mt5_cut,key 0,2.1,0 \
	- mt4_mt5.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R mt5 -b mt2,mt1,poly,diff,sti \
	-t mt6,mt7,mt8,mt9 -k mt4:0.36 -Maxw 2.1 -p \
	mt3:mt3_cut,key,mt5:mt5_cut,key 0,2.1,0 - mt3_mt5.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -h -b mt2,mt1,poly,diff,sti -t \
	mt5,mt6,mt7,mt8,mt9 -Maxw 2.1 -p mt3:mt3_cut,key,mt4:mt4_cut,key \
	0,2.1,0 - mt3_mt4.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R mt4 -b mt1,poly,diff,sti -t \
	mt5,mt6,mt7,mt8,mt9 -k mt3:0.36 -Maxw 2.1 -p \
	mt2:mt2_cut,key,mt4:mt4_cut,key 0,2.1,0 - mt2_mt4.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -h -b mt1,poly,diff,sti -t \
	mt4,mt5,mt6,mt7,mt8,mt9 -Maxw 2.1 -p mt2:mt2_cut,key,mt3:mt3_cut,key \
	0,2.1,0 - mt2_mt3.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R mt3 -b poly,diff,sti -t \
	mt4,mt5,mt6,mt7,mt8,mt9 -k mt2:0.36 -Maxw 2.1 -p \
	mt1:mt1_cut,key,mt3:mt3_cut,key 0,2.1,0 - mt1_mt3.sip
...
pax16 -V -lee_off -gnd ${CAP_GROUND} -rmselfC -ignore_cf_table -scf sip.cmd \
	-rP \
	np_rpoly_conn.res,np_rmetal1_conn.res,np_rmetal2_conn.res,np_rmetal3_conn.res,np_rmetal4_conn.res,np_rmetal5_conn.res,np_rmetal6_conn.res,mwires.res,rVia5.res,rVia4.res,rVia3.res,rvia2_out_capInd.res,rVia1.res,rcont_poly.res,rcont_pdiff.res,rcont_ndiff.res \
	-M_perim_off -c \
	/opt/cadence-designkits/gpdk090_v4.6/assura/rcx/qrcTechFile -f sti \
	diff poly:poly_cut mt1:mt1_cut mt2:mt2_cut mt3:mt3_cut mt4:mt4_cut \
	mt5:mt5_cut mt6:mt6_cut mt7 mt8 mt9 allGate - \
...
xreduce -V -mergecap -n NET -tech \
	...
	mt9,mt8,mt7,mt6,mt5,mt4,mt3,mt2,mt1,poly,diff,sti,np_rndiff_conn,np_rpdiff_conn,np_rnwell_conn,np_rpsubstrate,rVia1,rVia3,rVia4,rVia5,rcont_poly,rvia2_out_capInd \
	-mfactorR infinite -sr -g ${CAP_GROUND},1.0 -danglingR -minR 0.001 \
	-rPvia \
	rVia5.res,rVia4.res,rVia3.res,rvia2_out_capInd.res,rVia1.res,rcont_poly.res,rcont_pdiff.res,rcont_ndiff.res \
	-rP \
	np_rpoly_conn.res,np_rmetal1_conn.res,np_rmetal2_conn.res,np_rmetal3_conn.res,np_rmetal4_conn.res,np_rmetal5_conn.res,np_rmetal6_conn.res,mwires.res \
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -sc caps2dversion -mx capfile \
	...
	np_rmetal6_conn.res,Rnp_rmetal6_conn.dev2 \
	np_rmetal5_conn.res,Rnp_rmetal5_conn.dev2 \
	np_rmetal4_conn.res,Rnp_rmetal4_conn.dev2 \
	np_rmetal3_conn.res,Rnp_rmetal3_conn.dev2 \
	np_rmetal2_conn.res,Rnp_rmetal2_conn.dev2 \
	np_rmetal1_conn.res,Rnp_rmetal1_conn.dev2 \
	np_rpoly_conn.res,Rnp_rpoly_conn.dev2 rVia5.res,RrVia5.dev2 \
	rVia4.res,RrVia4.dev2 rVia3.res,RrVia3.dev2 \
	rvia2_out_capInd.res,Rrvia2_out_capInd.dev2 rVia1.res,RrVia1.dev2 \
	...
	_pmos_12_MOS_7.transr - NET - /home/pis7/Cadence/lab4_alu/extview.tmp

#==========================================================#
# Create _save_layers file for Assura extracted view
#==========================================================#

geom mt6 np_rmetal6_conn - np_rmetal6_conn,11,i,1
geom mt5 np_rmetal5_conn - np_rmetal5_conn,11,i,1
geom mt4 np_rmetal4_conn - np_rmetal4_conn,11,i,1
geom mt3 np_rmetal3_conn - np_rmetal3_conn,11,i,1
...
stamp -i2 np_rmetal4_conn rVia3 np_rVia3
stamp -i2 np_rmetal5_conn rVia4 np_rVia4
stamp -i2 np_rmetal6_conn rVia5 np_rVia5
stamp -i2 np_rmetal1_conn rcont_poly np_rcont_poly
stamp -i2 np_rmetal3_conn rvia2_out_capInd np_rvia2_out_capInd
...
metal6_conn np_rmetal6_conn p_rmetal6_conn
metal5_conn np_rmetal5_conn p_rmetal5_conn
metal4_conn np_rmetal4_conn p_rmetal4_conn
metal3_conn np_rmetal3_conn p_rmetal3_conn
...
via2_out_capInd np_rvia2_out_capInd p_rvia2_out_capInd
