#!/bin/ksh
# This script was generated Tue Feb 13 21:46:24 2024 by:
#
...
#	/home/pis7/Cadence/lab1inv_opt_inv_chain.xcn -assura_run_dir \
#	/home/pis7/Cadence -assura_run_name lab1inv_opt_inv_chain -rcxdir \
#	/home/pis7/Cadence/lab1inv_opt_inv_chain -xy_coordinates c,r -type \
#	full -temperature 25.0 -tempdir \
#	/home/pis7/Cadence/lab1inv_opt_inv_chain/rcx_temp -sub_node_char # \
...
#	/home/pis7/Cadence/lab1inv_opt_inv_chain/extview.tmp -net_name_space \
...
##ASSURA_RUN_NAME=lab1inv_opt_inv_chain
...
##NETS_FILE=/dev/null
##OUTPUT=/home/pis7/Cadence/lab1inv_opt_inv_chain/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/pis7/Cadence/lab1inv_opt_inv_chain
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/pis7/Cadence/lab1inv_opt_inv_chain/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
TEMPDIR=`setTempDir /home/pis7/Cadence/lab1inv_opt_inv_chain/rcx_temp`
export TEMPDIR
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/pis7/Cadence/lab1inv_opt_inv_chain
...
/home/pis7/Cadence/lab1inv_opt_inv_chain.xcn
ENDCAT
...
export GOALIE2DIR
vdbToRcx /home/pis7/Cadence lab1inv_opt_inv_chain -unit meters -mFactorR -- \
	-V1 -H satfile -r /home/pis7/Cadence/lab1inv_opt_inv_chain.xcn -df2 \
	-xgl
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -sc caps2dversion -mx capfile \
	...
	/home/pis7/Cadence/lab1inv_opt_inv_chain/extview.tmp
