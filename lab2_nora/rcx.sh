#!/bin/ksh
# This script was generated Tue Mar 26 21:03:11 2024 by:
#
...
#	/home/pis7/Cadence/lab2_nora.xcn -assura_run_dir /home/pis7/Cadence \
#	-assura_run_name lab2_nora -rcxdir /home/pis7/Cadence/lab2_nora \
#	-xy_coordinates c,r -type full -temperature 25.0 -tempdir \
#	/home/pis7/Cadence/lab2_nora/rcx_temp -sub_node_char # -res_models no \
#	-parasitic_res_models comment -parasitic_cap_models no \
#	-output_net_name_space layout -output_hierarchy_delimiter / -output \
#	/home/pis7/Cadence/lab2_nora/extview.tmp -net_name_space layout -minR \
...
##NETS_FILE=/dev/null
##OUTPUT=/home/pis7/Cadence/lab2_nora/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/pis7/Cadence/lab2_nora
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/pis7/Cadence/lab2_nora/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
TEMPDIR=`setTempDir /home/pis7/Cadence/lab2_nora/rcx_temp`
export TEMPDIR
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/pis7/Cadence/lab2_nora
...
/home/pis7/Cadence/lab2_nora.xcn
ENDCAT
...
export GOALIE2DIR
vdbToRcx /home/pis7/Cadence lab2_nora -unit meters -mFactorR -- -V1 -H \
	satfile -r /home/pis7/Cadence/lab2_nora.xcn -df2 -xgl
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -sc caps2dversion -mx capfile \
	...
	/home/pis7/Cadence/lab2_nora/extview.tmp
